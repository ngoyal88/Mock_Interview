"""Job posting requirement extraction — shared by Application Fit and Role-Targeted interview."""
import json
import re
...
logger = get_logger("JobPostingContextService")
...
def _safe_typed_requirements(value: Any, fallback: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    from services.application_fit.extract.typed_requirement_alignment import fallback_typed_requirements
