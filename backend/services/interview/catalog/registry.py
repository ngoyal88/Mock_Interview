...
from services.interview.modes.resume_deep_dive.start import ResumeDeepDiveModeStrategy
from services.interview.modes.role_targeted.start import RoleTargetedModeStrategy
...
class ModeStrategyRegistry:
    def __init__(self) -> None:
        ...
        from services.interview.modes.pair_programming.start import PairProgrammingModeStrategy
