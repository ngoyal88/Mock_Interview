...
from services.interview.session.lifecycle.completion_guard import cached_completion_from_session
...
from services.interview.session.persistence.session_store import SessionStore
