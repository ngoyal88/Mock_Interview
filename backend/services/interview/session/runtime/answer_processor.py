...
from services.interview.session.lifecycle.session_events import SessionEvent, SessionEventType
from services.interview.session.lifecycle.session_events import SessionEvent, SessionStateMachine
...
class AnswerProcessor:
    ...
    async def prepare_followup(self, session_id: str, user_answer: str) -> Dict[str, Any]:
        ...
        from services.interview.session.runtime.interview_service import _normalize_question_entry
        from services.interview.catalog.registry import parse_interview_type
