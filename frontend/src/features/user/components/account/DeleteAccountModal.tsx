...
import { hasPasswordProvider } from '../../utils/accountSettingsUtils';
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Delete account">
      ...
      <input
        ...
        className="profile-input mb-4 w-full"
      ...
      {passwordSignIn ? (
        <form onSubmit={handlePasswordSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex justify-end gap-3">
            <button type="button" className="profile-btn profile-btn--secondary" onClick={handleClose} disabled={deleting}>
              Cancel
            </button>
            <button
              type="submit"
